...
public class KnnCampaignOpportunityBid {
    ...
    public List<CampaignOpportunityBidHistory> getSimilarCampaignOpportunity(
            LearnStorage learnStorage, CampaignOpportunityMessage campaignOpportunity, double epsilon) {
        List<CampaignOpportunityBidHistory> similarCampaignOpportunity = new ArrayList<>();
        double distance;
        for (CampaignOpportunityBidHistory campaignOpportunityBidHistory : learnStorage
                .getCampaignOpportunityBidHistories()) {
    ...
    public List<CampaignOpportunityBidHistory> getKNearestNeighboursSimilarCampaignOpportunity(
            CampaignOpportunityMessage campaignOpportunity, List<CampaignOpportunityBidHistory>
            allSimilarCampaignOpportunity, int k) {
        ...
        List<Integer> kNearestCampaignOpportunityIndexes = getKNearestCampaignOpportunityIndexes
                (allNearestCampaignOpportunityDistances, k);
        for (int i : kNearestCampaignOpportunityIndexes) {
    ...
    private List<Integer> getKNearestCampaignOpportunityIndexes(List<Double> kNearestCampaignOpportunityDistances,
                                                                int k) {
    ...
    public double getSimilarCampaignOpportunityProfitAvg(List<CampaignOpportunityBidHistory>
                                                                 campaignOpportunityBidHistoriesList) {
        double profit = 0;
        for (CampaignOpportunityBidHistory campaignOpportunityBidHistories : campaignOpportunityBidHistoriesList) {
    ...
    public double getSimilarCampaignOpportunityCompleteRateAvg(List<CampaignOpportunityBidHistory>
                                                                       campaignOpportunityBidHistoriesList) {
    ...
    * we will use this routine result to find k nearest campaigns*/
    private double calcCampaignDistance(CampaignOpportunityBidHistory campaignOpportunityBidHistory,
        ...
        double impressionsDistance = Math.abs((double) campaignOpportunityBidHistory.getCampaignImpressions() -
                ...
                / ((double) campaignOpportunityBidHistory.getCampaignImpressions() + (double) campaignOpportunity
                .getReachImps());
        double marketSegmentDistance = Math.abs(campaignOpportunityBidHistory.getMarketSegmentRatio() -
                marketSegmentProbability.getMarketSegmentsRatio(campaignOpportunity.getTargetSegment()))
                / (campaignOpportunityBidHistory.getMarketSegmentRatio() + marketSegmentProbability
                .getMarketSegmentsRatio(campaignOpportunity.getTargetSegment()));
        double dayStartDistance = Math.abs((double) campaignOpportunityBidHistory.getDayStart() - (double)
                campaignOpportunity.getDayStart())
                / ((double) campaignOpportunityBidHistory.getDayStart() + (double) campaignOpportunity.getDayStart());
        double campaignOpportunityImpsPerDay = (double) campaignOpportunity.getReachImps() / ((double)
                campaignOpportunity.getDayEnd()
        ...
        double impressionsPerDayDistance = Math.abs((double) campaignOpportunityBidHistory.getImpressionsPerDay()
                ...
                / ((double) campaignOpportunityBidHistory.getImpressionsPerDay() + (double)
                campaignOpportunityImpsPerDay);
